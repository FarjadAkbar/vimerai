        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Confirm name, logo, primary color, and tone for Post Jobs and Video
              Jobs.
            </p>
          </div>
          <Button onClick={() => {
        ...
        {!isLoggedIn ? (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Create a Brand with name, logo, primary color, and tone.
              </CardDescription>
            </CardHeader>
            <CardContent>
      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Brand Confirm fields: name, logo, primary color, and tone.
            </DialogDescription>
          </DialogHeader>
          <Form {...formCreate}>
            <form
