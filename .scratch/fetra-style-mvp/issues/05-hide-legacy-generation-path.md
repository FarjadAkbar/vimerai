# 05 — Primary app = Fetra create path (hide legacy Generation)

**What to build:** The app’s primary path is Make a Post / Make a Video. Multi-arm Generation and Brand Kit–gated generate UX are hidden or demoted so users are not steered into the old Phase 1 loop.
